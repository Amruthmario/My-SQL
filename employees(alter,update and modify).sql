...
SELECT * FROM Employees WHERE Department='Account Management' AND status='Full Time' AND Salary > 8000;

SELECT Department,EmployeeId,First,Last,Status,Salary FROM Employees WHERE Department='Account Management' 
AND status='Full Time' AND Salary > 8000;

SELECT Department,EmployeeId,First,Last,Status,Salary FROM Employees WHERE Salary = 356000;

SELECT * FROM Employees;

SELECT * FROM Employees WHERE Department='Manufacturing' OR JobRating=4;

SELECT * FROM Employees WHERE Department != 'Manufacturing';

SELECT * FROM Employees WHERE Department IN ('IT','Sales','Manufacturing','Learnings');


SELECT count(*) FROM Employees;

SELECT count(*) FROM Employees  WHERE Department = 'Quality control';
...
SELECT * FROM Employees WHERE Status NOT IN ('contract','Half-Time','hourly');

SELECT DISTINCT(Status) FROM Employees; -- distinct means unique values 
...
SELECT count(distinct First) FROM Employees;

SELECT distinct First FROM Employees;

SELECT max(Salary), min(salary) FROM employees WHERE department='Manufacturing';

SELECT max(Salary), min(salary) FROM employees WHERE department='IT';
...
DESC customer; -- DESC( describe table) 
